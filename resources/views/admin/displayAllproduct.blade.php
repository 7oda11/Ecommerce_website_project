...
@section('content')
    <div class="container p-3">
        ...
        <div class="row justify-content-center">
            <div class="col-8">
                <a href="{{ route('product_admin.index') }}" class="btn btn-warning d-block w-100 mb-3"> Reset</a>
            </div>
        </div>
                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <div class="card-footer">
                                <form action="{{ route('product_admin.show', $product->id) }}" method="get">
                                ...
                                <form action="{{ route('product_admin.destroy', $product->id) }}" method="post">
                                    @csrf
                                    @method('delete')
